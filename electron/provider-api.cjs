/**
 * Synapse — Provider API Manager
 * Loads engine scripts into BrowserViews and provides unified sendViaAPI().
 * Each engine exposes window.__synapseXXX = { send, newConversation }.
 */
...
async function isAPIReady(provider, webContents) {
    const checkMap = {
        chatgpt: 'typeof window.__synapseChatGPT !== "undefined"',
        claude: 'typeof window.__synapseClaude !== "undefined"',
        gemini: 'typeof window.__synapseGemini !== "undefined"',
        perplexity: 'typeof window.__synapsePerplexity !== "undefined"',
        deepseek: 'typeof window.__synapseDeepSeek !== "undefined"',
        kimi: 'typeof window.__synapseKimi !== "undefined"'
    };
...
async function sendViaAPI(provider, webContents, message) {
    ...
    const sendMap = {
        chatgpt: '__synapseChatGPT',
        claude: '__synapseClaude',
        gemini: '__synapseGemini',
        perplexity: '__synapsePerplexity',
        deepseek: '__synapseDeepSeek',
        kimi: '__synapseKimi'
    };
...
async function resetConversation(provider, webContentsGetter) {
    ...
    const providers = provider ? [provider] : ['chatgpt', 'claude', 'gemini', 'perplexity', 'deepseek', 'kimi'];
