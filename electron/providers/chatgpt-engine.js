 ...
 */
(function() {
    if (window.__synapseChatGPT) return;
    ...
    async function send(message) {
        ...
        if (_conversationId) {
            ...
            console.log('[Synapse ChatGPT] Continuing conversation:', _conversationId);
        } else {
            console.log('[Synapse ChatGPT] Starting new conversation');
        }
    ...
    function newConversation() {
        ...
        console.log('[Synapse ChatGPT] Conversation reset');
    }

    window.__synapseChatGPT = { send: send, newConversation: newConversation };
    console.log('[Synapse] ChatGPT engine loaded');
