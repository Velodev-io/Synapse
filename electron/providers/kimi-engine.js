...
(function() {
    ...
    async function fn_send(message) {
        ...
        if (!_chatSessionId) {
            ...
            console.log('[Proxima Kimi] Created new session:', _chatSessionId);
        }
    ...
    function newConversation() {
        _chatSessionId = null;
        console.log('[Proxima Kimi] Conversation reset');
    }

    window.__proximaKimi = { send: fn_send, newConversation: newConversation };
