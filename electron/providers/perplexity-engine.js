/**
 * Synapse — Perplexity Engine v4.1.0
 ...
 */
(function () {
    if (window.__synapsePerplexity) return;
    ...
    function newConversation() {
        ...
        _sessionToken = null;
        console.log('[Synapse Perplexity] Conversation reset');
    }

    window.__synapsePerplexity = { send: send, newConversation: newConversation };
    console.log('[Synapse] Perplexity engine loaded');
})();
