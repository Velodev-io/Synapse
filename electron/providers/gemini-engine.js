 ...
 */
(function() {
    if (window.__synapseGemini) return;
    ...
    function _parseResponse(rawText) {
        ...
        // Gemini nests conversation IDs at inner[1][0], inner[1][1], inner[4][0][0]
            ...
            if (_conversationId) {
                console.log('[Synapse Gemini] Captured conversation context: ' + _conversationId.substring(0, 20) + '...');
            }
        } catch(e) {}
    ...
    async function send(message) {
        ...
        if (_conversationId) {
            console.log('[Synapse Gemini] Continuing conversation: ' + _conversationId.substring(0, 20) + '...');
        } else {
            console.log('[Synapse Gemini] Starting new conversation');
        }
    ...
    function newConversation() {
        ...
        _responseId = '';
        _choiceId = '';
        console.log('[Synapse Gemini] Conversation reset');
    }

    window.__synapseGemini = { send: send, newConversation: newConversation };
    console.log('[Synapse] Gemini engine loaded');
})();
